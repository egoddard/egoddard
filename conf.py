...
BLOG_AUTHOR = "Eric Goddard"  # (translatable)
BLOG_TITLE = "Eric Goddard"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://egoddard.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://egoddard.github.io/"
BLOG_EMAIL = "egoddard1010@gmail.com"
BLOG_DESCRIPTION = "Eric Goddard"  # (translatable)
...
NAVIGATION_LINKS = {
       DEFAULT_LANG: (
           ...
           ('https://twitter.com/eric_god', 'My Twitter', 'icon-twitter'),
           ('https://github.com/egoddard', 'My Github', 'icon-github'),
       )
   }
